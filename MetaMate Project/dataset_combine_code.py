...
lpl23_spring = pd.read_csv("LPL23_Sping_comp.csv")
lpl23_spring_playoff = pd.read_csv("LPL23_Spring_Playoff_comp.csv")
lpl23_summer = pd.read_csv("LPL23_Summer_comp.csv")
lpl23_summer_playoff = pd.read_csv("LPL23_Summer_Playoff_comp.csv")
team_comp = pd.concat([lck23_spring, lck23_spring_playoff,lck23_summer,lck23_summer_playoff,world23_playin,world23_stage,lpl23_spring,lpl23_spring_playoff, lpl23_summer, lpl23_summer_playoff ], axis=0, ignore_index=True)
